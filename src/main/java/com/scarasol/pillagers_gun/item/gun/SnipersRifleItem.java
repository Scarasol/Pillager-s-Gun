...
public class SnipersRifleItem extends GunItem{
    ...
    public SnipersRifleItem() {
        super(new Item.Properties().stacksTo(1).rarity(Rarity.COMMON));
    }

    @Override
    public SoundEvent getFireSound(){
        return PillagersGunSounds.snipers_rifle_fire.get();
    }

    @Override
    public SoundEvent getReloadSound(){
        return PillagersGunSounds.snipers_rifle_reload.get();
    }

    @Override
    public AmmoItem getAmmo(){
        return (AmmoItem) PillagersGunItems.SNIPERS_RIFLE_AMMO.get();
    }
    ...
    public boolean shouldRenderLaser() {
        return CommonConfig.SNIPERS_RENDER_LASER.get();
    }
}
