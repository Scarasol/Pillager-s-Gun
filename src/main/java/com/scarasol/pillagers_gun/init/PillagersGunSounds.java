...
public class PillagersGunSounds {
    ...
    public static final RegistryObject<SoundEvent> bullet_hit_body = REGISTRY.register("bullet_hit_body", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(PillagersGunMod.MODID, "bullet_hit_body")));
    public static final RegistryObject<SoundEvent> bullet_hit_ground = REGISTRY.register("bullet_hit_ground", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(PillagersGunMod.MODID, "bullet_hit_ground")));
    public static final RegistryObject<SoundEvent> shotgun_fire = REGISTRY.register("shotgun_fire", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(PillagersGunMod.MODID, "shotgun_fire")));
